...
function App() {
  ...
  return (
    <div className="bg-mbgcl overflow-x-hidden font-body">
      ...
      <div className="flex flex-col gap-gbe mb-[3rem] mt-[2rem]">
        
          <ParallaxLayer speed={1.5} factor={4} onClick={() => ref.current.scrollTo(1)}>
          <div className="border-2 mx-8 my-8 border-textc border-solid flex flex-col">
              ...
              <div className="flex h-128">
                  ...
                  <div className="bg-ssbgcl overflow-hidden w-1/2 flex justify-center items-center">
                      <div className="w-96 h-picf relative z-10">
          ...
          <ParallaxLayer offset={2} speed={0.5} onClick={() => ref.current.scrollTo(0)}>
